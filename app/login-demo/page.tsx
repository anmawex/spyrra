          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all text-lg"
            ...
            <Button
              type="submit"
              className="w-full py-3 text-lg font-semibold shadow-lg shadow-orange-500/30"
              disabled={loading}
            >
