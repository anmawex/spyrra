...
import { CreditCard, DollarSign, Calendar, CheckCircle, AlertCircle, RefreshCw } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const oldLoans = userData?.creditRequests.filter(c => c.status === 'completed') || []
